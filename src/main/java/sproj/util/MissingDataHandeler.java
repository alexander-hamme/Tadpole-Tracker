...
/**
 * Class to interpolate occasional missing coordinates (due to human error)
 * in the manually labeled data generated by the FrameLabeler class
 */
