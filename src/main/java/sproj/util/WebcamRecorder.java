...
//    private final static int WEBCAM_DEVICE_INDEX = 1;       // 0 is the laptop webcam --> on desktop it'll depend if a monitor is plugged in that has a webcam
    ...
    private void initializeFrameGrabber(String videoPath) throws FrameGrabber.Exception {
        ...
        if (new File(videoPath).exists()) {
            ...
            try{
                ...
                throw new IllegalArgumentException("Video path is neither a valid video file nor a camera index number", e);
            }
...
//        grabber.setImageHeight(captureHeight);
        ...
        while ((capturedFrame = grabber.grab()) != null)
        {
            ...
            KeyEvent keyPressed = cFrame.waitKey(100);
            if (keyPressed != null) {
